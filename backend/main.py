...
class fitbark_endpoints:
    ...
    dog_id_and_auth = "/<string:key:>/<int:id>/"
...
@app.route(fibark_endpoints.dog_picture)
def dog_picture(key,id):
    return get_dog_picture(key,id)

@app.route(fibark_endpoints.dog_info)
def dog_info(key,id):
    return get_dog_info(key,id)

@app.route(fibark_endpoints.dog_activity)
def dog_activity(key,id):
    return get_dog_activity(key,id)

@app.route(fibark_endpoints.dog_goal)
def dog_goal(key,id):
